...
<body style="background-color: yellow!important">
	<div class="main">
		...
		<h1 style="color: red!important">Amount to be paid = <?php echo $amt; ?></h1>
		<div class="content">
		 ...
		 <pre id="footer-text" style="margin-left: 100px; text-align: center">Copyright &copy;DryfruitBasket</pre>
	</div>
</body>
</html>